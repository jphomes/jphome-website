  ...
  return (
    <div className="page-wrap py-6 md:py-12">
      <div className="mb-8">
        ...
        <h1 className="font-display text-2xl md:text-4xl text-primary font-semibold">Contact JP Homes</h1>
      ...
      <div className="contact-grid">
        <div className="space-y-4">
          ...
          <SocialLinks className="text-secondary" />

          <div className="contact-map-wrap">
            <iframe
              title={`${BRAND.fullName} location map`}
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3718.7321714561112!2d81.63702839999999!3d21.2424666!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a28dd0eca7bd893%3A0x7c4693a26fca391!2sJP%20Homes!5e0!3m2!1sen!2sin!4v1788877421348!5m2!1sen!2sin"
              allowFullScreen
              loading="lazy"
